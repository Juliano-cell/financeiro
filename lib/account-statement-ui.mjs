...
const EVENT_PRESENTATION = {
  ...
  expected_income_receipt: { label: "Recebimento de entrada prevista", direction: "credit" },
  expected_income_reversal: { label: "Estorno de entrada prevista", direction: "debit" },
