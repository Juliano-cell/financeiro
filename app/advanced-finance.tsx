...
type Invoice = CanonicalInvoice & { status: "open" | "closed" | "paid"; totalCents: number; installments: Installment[]; openingBalance: { originalCents: number; allocatedCents: number; residualCents: number; identifiedCents: number } | null };
